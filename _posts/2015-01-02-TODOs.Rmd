...
# fn <- "2015-01-02-TODOs.Rmd" ; knit(fn)  # to get the .md file # library(knitr) ; library(knitrBootstrap)
# https://github.com/jimhester/knitrBootstrap#bootstrap-themes
# rmarkdown::render(fn, knitrBootstrap::bootstrap_document())
...
output:
  ...
  knitrBootstrap::bootstrap_document: #  to create bootstrap styled HTML reports - not .md
    ...
    theme: cyborg # cyborg slate darkly superhero cerulean 
    #theme.chooser: TRUE # (FALSE) - Add a bootstrap style chooser to the page.
    # highlight - (HighlightJS) - Set the default code style.
    highlight: google code # https://github.com/jimhester/knitrBootstrap#highlight-themes
    # highlight.chooser: TRUE # (FALSE) - Add a code style chooser to the page.
    menu: TRUE # FALSE # Whether to include the bottom navbar.
    # true toc: Automatic table of contents constructed from h1-4 tags. https://github.com/jimhester/knitrBootstrap
...
```{r in main file, eval = TRUE, echo = FALSE, results = 'hide'}
bib
```
