...
## 1: kraken  BTC   EUR 2015-01-31 15:19:16             <NA> 204.77 203.8848
##      volume ask    bid
## 1: 2706.066 205 204.72
```
...
```
## 
## 2015-01-31 15:19:16: market.api.process: processing started for kraken trades
## 2015-01-31 15:19:16: market.api.process: API call request pre-processed
## 2015-01-31 15:19:17: market.api.process: market level errors checked, no errors occurred
## 2015-01-31 15:19:20: market.api.process: API call result post-processed
## 2015-01-31 15:19:20: market.api.process: processing finished for kraken trades
```
...
##  $ base            : chr "BTC"
##  $ quote           : chr "EUR"
##  $ timestamp       : POSIXct[1:1], format: "2015-01-31 15:19:17"
##  $ market_timestamp: POSIXct[1:1], format: NA
##  $ trades          :Classes 'data.table' and 'data.frame':	1000 obs. of  5 variables:
##   ..$ date  : POSIXct[1:1000], format: "2015-01-31 07:37:20" ...
##   ..$ price : num [1:1000] 205 205 205 204 205 ...
##   ..$ amount: num [1:1000] 0.0146 24.834 2.108 0.665 0.3 ...
##   ..$ tid   : chr [1:1000] NA NA NA NA ...
##   ..$ type  : chr [1:1000] "bid" "bid" "bid" "ask" ...
...
##    1: 2015-01-31 07:37:20 205.0000  0.01462765                  NA  bid
##    2: 2015-01-31 07:37:20 205.0000 24.83401597                  NA  bid
##    3: 2015-01-31 07:37:38 204.6582  2.10803923                  NA  bid
##    4: 2015-01-31 07:37:43 204.2038  0.66500000                  NA  ask
##    5: 2015-01-31 07:38:15 204.6582  0.30000000                  NA  bid
##   ---                                                                  
##  996: 2015-01-31 15:16:28 205.1717  0.50000000                  NA  ask
##  997: 2015-01-31 15:16:28 205.1617  0.00341194                  NA  ask
##  998: 2015-01-31 15:16:50 204.9000  0.01000000                  NA  ask
##  999: 2015-01-31 15:16:50 204.7300  0.99000000                  NA  ask
## 1000: 2015-01-31 15:18:05 204.7700  0.50000000 1422717485508299657  ask
```
...
```
## Error in eval(expr, envir, enclos): object 'singleaddress' not found
```
...
```
## Error in eval(expr, envir, enclos): object 'txs' not found
```
...
Vignette generated in 9 seconds.   
<p>Timestamp 2015-01-31 15:19:22. <!-- Date the vignette was generated -->
